...
wget https://raw.githubusercontent.com/oluwa200/jenkins-master-client-project/maven-sonarqube-nexus-jenkins-install/settings.xml -P /home/jenkinsmaster/.m2/
